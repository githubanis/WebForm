<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Calender.aspx.cs" Inherits="Categories_Electronics_Calender" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:ImageButton ID="ImageButton1" runat="server" Height="24px" ImageUrl="~/Uploads/myPhoto1.jpg" OnClick="ImageButton1_Click" />
            <br />
